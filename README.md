...
Atuo na área de TI com experiência prática em suporte, infraestrutura e resolução de problemas em ambientes corporativos.

Atualmente, estou direcionando minha carreira para o desenvolvimento frontend, criando interfaces intuitivas e aplicações que entregam uma boa experiência ao usuário.

Busco evoluir continuamente, aplicando boas práticas de código e desenvolvendo soluções funcionais para problemas reais.
